...
DiceSimilarity.prototype.getSimilarity = function(str1, str2) {
	var str1Tokens = lodash.uniq(this.tokeniser.tokenizeToArray(str1));
	var str2Tokens = lodash.uniq(this.tokeniser.tokenizeToArray(str2));

	var terms1 = str1Tokens.length;
	var terms2 = str2Tokens.length;

	var commonTerms = (terms1 + terms2) - lodash.uniq(str1Tokens.concat(str2Tokens)).length;
